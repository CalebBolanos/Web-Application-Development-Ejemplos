<%-- 
    ...
    Created on : 24 oct. 2021, 12:47:00
    Author     : caleb
--%>
            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach var="dto" items="${listaDeUsuarios}">
                        <tbody>
                            <tr>
                                <td><a href="UsuarioServlet?accion=ver&id=<c:out value="${dto.entidad.idUsuario}" />" class="btn btn-outline-warning"><c:out value="${dto.entidad.idUsuario}" /></a></td>
                                ...
                                <td>
                                    <a href="UsuarioServlet?accion=verReporte&id=<c:out value="${dto.entidad.idUsuario}"/>" class="btn btn-outline-info">Reporte</a>
                                </td>
                            </tr>
                        </tbody>
                    </c:forEach>
