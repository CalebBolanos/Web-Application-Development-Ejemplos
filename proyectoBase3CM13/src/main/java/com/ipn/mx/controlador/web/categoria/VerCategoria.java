...
public class VerCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (dto != null) {
                out.println("<ol>");
                out.println("<li>" + dto.getEntidadad().getIdCategoria() + "</li>");
                out.println("<li>" + dto.getEntidadad().getNombreCategoria() + "</li>");
                out.println("<li>" + dto.getEntidadad().getDescripcionCategoria() + "</li>");
                out.println("</ol>");
            }
